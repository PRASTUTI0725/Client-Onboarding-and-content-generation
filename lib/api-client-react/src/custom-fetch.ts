...
let _defaultHeaders: HeadersInit | null = null;
...
/**
 * Set default headers that are merged into every request before per-request
 * headers are applied.
 */
export function setDefaultHeaders(headers: HeadersInit | null): void {
